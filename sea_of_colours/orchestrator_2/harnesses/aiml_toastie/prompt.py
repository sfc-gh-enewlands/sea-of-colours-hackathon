...
from sea_of_colours.orchestrator_2.harnesses.aiml_toastie._v7.prompt import (
    format_state_block,
...
from sea_of_colours.orchestrator_2.harnesses.aiml_toastie import weapon_forge
...
def build_prompt(
    *,
    ...
    parts += [
        ...
        counter_chaff.format_discovery_block(agent_view), "\n",
    ]
